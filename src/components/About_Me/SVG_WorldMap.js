...
const markers = [
  { markerOffset: 10, name: "Adelaide", coordinates: [138.599503, -34.92123] },
  { markerOffset: 10, name: "Sydney", coordinates: [151.2099, -33.865143] },
  {
    markerOffset: 20,
    name: "Melbourne",
  ...
  },
  {
    markerOffset: 20,
    name: "Gold Coast",
    coordinates: [153.399994, -28.016666],
  },
];
        ...
        {markers.map(({ name, coordinates, markerOffset }) => (
          <Marker key={name} coordinates={coordinates}>
            <g
              ...
              onMouseLeave={() => {
                setCurrent("Hover to one of the marker");
              }}
            >
